...
En este proyecto se propuso la creación de una biblioteca de manejo de hilos llamada de procesamiento "my_pthread" a nivel de la capa de usuario para sistemas operativos Linux, ademas de una aplicación de animación multidisplay que corra sobre la biblioteca creada.
...
En esta sección se puede detallar que en el código las principales estructuras usadas fueron vectores, listas y ademas los objetos de **MyPthread**, se puede decir que es el hilo como tal y la estructura **PthreadPool**, la cual es un objeto que contiene los hilos creados en los diferentes apartados según el scheduler que se les hay definido, ademas de regular todos los contenidos y datos necesarios para la ejecución del programa, también se utilizaron objetos como la tómbola o los tickets en el scheduler de Lottery pero no son estructuras vitales. En la animación la estructura utilizada es de tipo WINDOW, además de las ya mencionadas.
...
- animation(file: Vec<String>): función que se encarga de realizar la animación dadas las configuraciones requeridas. Se encarga de crear el canvas y de realizar los movimientos a la figura.
...
- `main()`: Función principal del código donde se crean los procesos y se define el inicio de la ejecución.
  ...
  Para ejecutar el programa una vez compilado, se debe escribir en la terminal lo siguiente:

- `./binario animar -c path`

  - binario: proyecto1_SO_MultidsplayAnimator 
  - path: ruta absoluta donde se encuentre el archivo de configuración txt
  - La terminal debe ubicarse en el proyecto en el directorio /taget/debug/
  ...
  | 26/10/2022   | 17:00          | 22:00      | 4:00                | Documentación                                                | Luis Andrés Rojas Murillo |
  | 27/10/2022   | 8:00           | 10:00      | 2:00                | Documentación interna                                        | Luis Andrés Rojas Murillo |
  | 26/09/2022   | 19:00          | 23:00      | 4:00                | Investigación                                                | Royner Miranda Segura     |
  | 29/09/2022   | 18:00          | 22:00      | 4:00                | Investigación y pruebas de implementacion                    | Royner Miranda Segura     |
  | 08/10/2022   | 11:00          | 17:00      | 8:00                | Implementacion de codigo                                     | Royner Miranda Segura     |
  | 15/10/2022   | 11:00          | 17:00      | 8:00                | Implementacion de codigo                                     | Royner Miranda Segura     |
  | 25/10/2022   | 18:00          | 24:00      | 6:00                | Implementacion del animator                                  | Royner Miranda Segura     |
  | 26/10/2022   | 00:00          | 05:00      | 5:00                | Implementacion del animator                                  | Royner Miranda Segura     |
  | 26/10/2022   | 18:00          | 24:00      | 6:00                | Funcionalidad del animator                                   | Royner Miranda Segura     |
  | 27/10/2022   | 00:00          | 01:30      | 1:30                | Cambio del parser                                            | Royner Miranda Segura     |
  | 27/10/2022   | 17:00          | 19:00      | 2:00                | Cambios en el código                                         | Royner Miranda Segura     |
  | 27/10/2022   | 19:00          | 20:00      | 3:00                | Documentación                                                | Royner Miranda Segura     |
  | ------------ | -------------- | ---------- | ------------------- | -------------------------------------------------------------------------- | ------------------------- |
  |              |                |            | 60:00               | Total de horas invertidas                                    | Luis Andrés Rojas Murillo |
  |              |                |            | 47:30               | Total de horas invertidas                                    | Royner Miranda Segura     |
  #### Historial de commits:

  commit 7a4f5ad49367b34f0add33a8eb78c3bef5a04540 (HEAD -> main, origin/main, origin/HEAD)
  Author: LuisAndresTEC <lrojasmurillo7@estudiantec.cr>
  Date:   Thu Oct 27 20:13:21 2022 -0600

      ultimos detalles del codigo

  commit fa0e267fd36b6524a0c47051966d371ec01c742a
  Author: Royner <roynerarturo39@gmail.com>
  Date:   Thu Oct 27 18:57:02 2022 -0600

      Version funcional del proyecto

  commit 79dbb813ff2a2bfbeb612e61be93e66fd16364e4
  Author: Royner39 <roynerarturo39@gmail.com>
  Date:   Thu Oct 27 02:04:08 2022 -0600

      Rotación y Modificación Parser

  commit eb96abf1a37e717e81bbabd242a28aa89312a33e
  Author: Royner39 <roynerarturo39@gmail.com>
  Date:   Wed Oct 26 22:57:38 2022 -0600

      Integración Animator con MyPthread
      
      Se actualiza el main y la documentación, se agregan dependencias

  commit 4ca92ef6994783cbfcc2c2a6f06a4f931f54a688
  Author: Royner39 <roynerarturo39@gmail.com>
  Date:   Wed Oct 26 22:03:13 2022 -0600

      Animación
      
      Se crea el canvas, se cambia el parser, funcionalidad de la animación

  commit 3af3442d5f94d0065ac6a912488ee796e4c21079
  Author: LuisAndresTEC <lrojasmurillo7@estudiantec.cr>
  ...
  | Puntaje | Criterio                           |
  | ------- | ---------------------------------- |
  | 5       | Aprendizaje de Round Robin.        |
  | 5       | Aprendizaje de Tiempo Real.        |
  | 5       | Aprendizaje de Cambio de contexto. |
  | 5       | Aprendizaje de Sorte.              |
  ...
  | 5       | Aprendizaje de Round Robin.        |
  | 5       | Aprendizaje de Tiempo Real.        |
  | 4       | Aprendizaje de Cambio de contexto. |
  | 5       | Aprendizaje de Sorte.              |
  ...
  ​	Este ha sido un proyecto bastante sufrido, se podría decir que muy enriquecedor dado que refuerza y aplica TODOS los contenidos aprendidos en esta unidad de procesos, sin embargo, se puede considerar de alta complejidad y con un enfoque muy amplio lo cual da espacio a la aparición de problemáticas ajenas al área de estudio, que ayuda al proceso de aprendizaje. De mi parte me gustó el proyecto y el trabajo sin embargo creo que hay muy pocas refencias para este tipo de trabajos y la informacion no abunda.

  

  #### Royner Arturo Miranda Segura:

  ​	En este proyecto aprendí como se manejan los hilos desde el interior y la estructura que poseen, también como implementar los diferentes tipos de schedulers y en que momento utilizarlos. La parte de la animación me gustó bastante. En general con el proyecto se logra aprender bastante, sin embargo si requiere bastante tiempo, ya que además de la implementación hay que investigar bastante, diría que es lo que más toma tiempo ya que no hay muchos sitios que realmente sirvan y si encuentra por lo general no es en Rust. 

  ## Bibliografía:

  [1]	A. S. Tanenbaum, Distributed Operating Systems. Delhi, India: Pearson Education, 2009.
  [2]	“Docs.Rs,” Docs.rs. [Online]. Available: https://docs.rs/. [Accessed: 28-Oct-2022].
  [3]	“The rust programming language - the rust programming language,” Rust-lang.org. [Online]. Available: https://doc.rust-lang.org/book/. [Accessed: 28-Oct-2022].
  [4]	Casual Coder, “Ncurses Tutorial 2 - Basics of Windows (WINDOW*, newwin, box, refresh, wrefresh, wprintw mvwprintw),” 11-Dec-2016. [Online]. Available: https://www.youtube.com/watch?v=pjT5wq11ZSE. [Accessed: 28-Oct-2022].
  [5]	G. Raptor, “NCurses Tutorial 1 Introduction to NCurses,” 24-May-2014. [Online]. Available: https://www.youtube.com/watch?v=2tWN6ntNo4w. [Accessed: 28-Oct-2022].
